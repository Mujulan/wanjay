...
m.reply(mess.wait)
                ...
                .on('exit', () => {
               kagura.sendMessage(m.chat, { image: fs.readFileSync('./nulis/buku/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                m.reply(`*1 Limit Terpakai*\n*Sisa Limit Anda : ${global.db.data.users[m.sender].limit}*`)
break
...
.on('error', () => m.reply('error'))
.on('exit', () => {
kagura.sendMessage(m.chat, { image: fs.readFileSync('./nulis/buku/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
m.reply(`*1 Limit Terpakai*\n*Sisa Limit Anda : ${global.db.data.users[m.sender].limit}*`)
break
...
m.reply(mess.wait)
                ...
                .on('error', () => m.reply('error'))
                .on('exit', () => {
                kagura.sendMessage(m.chat, { image: fs.readFileSync('./nulis/buku/folio/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
...
m.reply(mess.wait)
                ...
                .on('error', () => m.reply('error'))
                .on('exit', () => {
                kagura.sendMessage(m.chat, { image: fs.readFileSync('./nulis/buku/folio/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
                m.reply(`*1 Limit Terpakai*\n*Sisa Limit Anda : ${global.db.data.users[m.sender].limit}*`)
break
